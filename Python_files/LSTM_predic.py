...
import os
os.environ['CUDA_VISIBLE_DEVICES'] = '4' # Allow only 1 GPU visible to CUDA
...
complex_network_Model=load_model('project2_LSTM_network.h5')
...
plt.show()
plt.savefig('project2_LSTM_high_prob_waveform.png')
    ...
    for i in visited:
        if i[1] == clas:
          if count < 5:
            ...
            ax.set_title('classes:'+str(clas))
plt.show()
plt.savefig('project2_LSTM_low_prob_waveform.png')
